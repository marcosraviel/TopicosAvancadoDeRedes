...
wget https://github.com/marcosraviel/TopicosAvancadoDeRedes/raw/master/languages.tar.gz
...
sed -i ""$n"s/: '';/: 'Site Raviel Class Arcanist';/" /var/www/html/wordpress/wp-admin/install.php
